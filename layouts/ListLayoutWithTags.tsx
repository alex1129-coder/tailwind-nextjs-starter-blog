                  ...
                  return (
                    <li key={t} className="my-1">
                      {isActive ? (
                        ...
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="flex items-center px-3 py-2 text-sm font-medium text-gray-500 uppercase hover:text-[#1A4D3A] dark:text-gray-300 dark:hover:text-[#9CBFB3]"
                          aria-label={`查看標籤 ${t} 的文章`}
                        >
                          {`${t} (${tagCounts[t]})`}
                        </Link>
                      )}
